...
{
	[AddComponentMenu("UI/Icon Slots/ItemsManager Slot", 12)]
	public class UIItemSlot : UISlotBase, IUIItemSlot
    {
        ...
        protected override void OnEnable()
        {
            ...
            if (!this.IsInPrefabStage())
            {
                ...
                if (duplicate != null)
                {
                    int oldId = this.m_ID;
                    this.AutoAssignID();
                    Debug.LogWarning("ItemsManager Slot with duplicate ID: " + oldId + " in Group: " + this.m_SlotGroup + ", generating and assigning new ID: " + this.m_ID + ".");
                }
            }
#endif
        }
		...
		/// </summary>
		/// <param name="itemInfo">ItemsManager info.</param>
